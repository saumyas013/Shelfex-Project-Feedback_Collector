package com.shelfex.feedback.util;
...
public class JwtUtil {
    ...
    public String generateToken(UserDetails userDetails) {
        ...
        // You can add more claims here, e.g., user roles
    ...
    private String createToken(Map<String, Object> claims, String subject) {
        return Jwts.builder()
                ...
                .setExpiration(new Date(System.currentTimeMillis() + EXPIRATION_TIME)) // Use configured expiration
